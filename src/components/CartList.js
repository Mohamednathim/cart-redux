...
import { Change_Quantity, Delete_From_Cart } from "../slices/CartSlice";
...
const CartList = () => {
  ...
  const changeQuantity = (item, newQuantity) => {
    dispatch(Change_Quantity({ id: item.id, quantity: newQuantity }));
  };
          ...
          {cart.items.map((item) => (
            ...
            >
              ...
              <div className="card-body cart-body">
                ...
                <p className="card-title">
                  <b>Total Quantity : {item.quantity}</b>
                </p>
                <p className="card-title">
                  <b>Shipping : FREE🎁 </b>
                </p>
                <p className="card-title">
                  <b>Total Amount : ${item.price * item.quantity}</b>
                </p>
